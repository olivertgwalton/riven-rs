...
/**
 * The slices of the schema these operations actually select.
 *
 * `Pick` rather than a redeclaration: the field names and nullability come from
 * `schema.graphql`, so renaming or dropping a field in the backend fails to
