...
pub static RE_YEAR_RANGE: LazyLock<Regex> =
...
pub static RE_SEASON_FULL: LazyLock<Regex> = LazyLock::new(|| {
...
pub static RE_SEASON_RANGE: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)(?:^|[.\s\[(])S(\d{1,3})\s*[-–—]+\s*S(\d{1,3})\b").unwrap());
pub static RE_SEASON_MULTI: LazyLock<Regex> = LazyLock::new(|| {
...
pub static RE_EPISODE_STANDALONE: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(r"(?i)\bE(\d{1,4})(?:\s*[-+&]\s*E?(\d{1,4}))*(?:\b|[.\s])").unwrap()
});
pub static RE_EPISODE_FULL: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(
...
pub static RE_Q_TELECINE: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\b(?:HD[ .\-]*)?T(?:ELE)?C(?:INE)?(?:Rip)?\b").unwrap());
pub static RE_Q_SCR: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\b(?:DVD?|BD|BR|HD)?[ .\-]*Scr(?:eener)?\b").unwrap());
pub static RE_Q_PRE_DVD: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bP(?:RE)?[ .\-]*(?:HD|DVD)(?:Rip)?\b").unwrap());
pub static RE_Q_BLURAY_REMUX1: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bBlu[ .\-]*Ray\b").unwrap());
pub static RE_Q_BLURAY_REMUX2: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)(?:BD|BR|UHD)[- ]?remux").unwrap());
pub static RE_Q_BLURAY_REMUX3: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)(?:remux.*)\bBlu[ .\-]*Ray\b").unwrap());
pub static RE_Q_REMUX: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bremux\b").unwrap());
pub static RE_Q_BLURAY: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bBlu[ .\-]*Ray\b").unwrap());
pub static RE_Q_UHDRIP: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bUHD[ .\-]*Rip\b").unwrap());
pub static RE_Q_HDRIP: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)(?:\bHD[ .\-]*Rip\b|\bMicro\s*HD\b)").unwrap());
pub static RE_Q_BRRIP: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\b(?:BR|Blu[ .\-]*Ray)[ .\-]*Rip\b").unwrap());
pub static RE_Q_BDRIP: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(r"(?i)(?:\bBD[ .\-]*Rip\b|\bBDR\b|\bBD-RM\b|[(\[]BD[\]). ,\-])").unwrap()
});
pub static RE_Q_DVDRIP: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\b(?:HD[ .\-]*)?DVD[ .\-]*Rip\b").unwrap());
pub static RE_Q_VHSRIP: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bVHS[ .\-]*Rip?\b").unwrap());
pub static RE_Q_DVD: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bDVD(?:R\d?|.*Mux)?\b").unwrap());
pub static RE_Q_VHS: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bVHS\b").unwrap());
pub static RE_Q_PPVRIP: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bPPV[ .\-]*Rip\b").unwrap());
pub static RE_Q_HDTVRIP: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bHDTV[ .\-]*Rip\b").unwrap());
pub static RE_Q_SATRIP: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bSAT[ .\-]*Rip\b").unwrap());
pub static RE_Q_TVRIP: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bTV[ .\-]*Rip\b").unwrap());
pub static RE_Q_R5: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bR[56]\b").unwrap());
pub static RE_Q_WEBMUX: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\b(?:DL|WEB|BD|BR)MUX\b").unwrap());
pub static RE_Q_WEBRIP: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bWEB[ ._\-]*Rip\b").unwrap());
pub static RE_Q_WEBDLRIP: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bWEB[ ._\-]?DL[ ._\-]?Rip\b").unwrap());
pub static RE_Q_WEBDL: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bWEB[ ._\-]*(?:DL|\.BDrip|\.DLRIP)\b").unwrap());
pub static RE_Q_WEB: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)(?:^|[\s.\-\[(])WEB(?:[\s.\-\])]|$)").unwrap());
pub static RE_Q_CAM: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(r"(?i)\b(?:H[DQ][ .\-]*)?CAM(?:H[DQ])?(?:[ .\-]*Rip|Rp)?\b").unwrap()
});
pub static RE_Q_CAM_FALSE: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bCAM.?(?:S|E|\()\d+").unwrap());
pub static RE_Q_PDTV: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bPDTV\b").unwrap());
...
pub static RE_CODEC_XVID: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)(?:^|[\W_])(?:xvid|divx)(?:$|[\W_])").unwrap());
pub static RE_CODEC_AV1: LazyLock<Regex> =
...
pub static RE_AUDIO_DTS_LOSSY: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bDTS(?:[ .\-]?HD(?:[ .\-]?HR)?)?\b").unwrap());
pub static RE_AUDIO_ATMOS: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\b(?:Dolby[ .\-]*)?Atmos\b").unwrap());
pub static RE_AUDIO_TRUEHD: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\b(?:True[ .\-]?HD|\.True\.)\b").unwrap());
pub static RE_AUDIO_TRUEHD_BARE: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"\bTRUE\b").unwrap());
pub static RE_AUDIO_FLAC: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bFLAC(?:\d\.\d)?(?:x\d+)?\b").unwrap());
pub static RE_AUDIO_DD_PLUS: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(
        r"(?i)(?:\b(?:DD2?P(?:\d(?:\.\d)?)?|DDP(?:\d(?:\.\d)?)?|Dolby\s*Digital\s*Plus|DD\s*Plus|E[ .\-]?AC[ .\-]?3|EAC3)\b|\bDD\+(?:\d(?:\.\d)?)?(?:$|[\s)\].,_-]))(?:-S\d+)?",
    )
    .unwrap()
});
pub static RE_AUDIO_DD: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(r"(?i)\b(?:DD(?:\d(?:\.\d)?)?|Dolby\s*Digital|DolbyD|AC[ .\-]?3(?:x2)?(?:-S\d+)?)\b")
        .unwrap()
});
pub static RE_AUDIO_AAC: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bQ?Q?AAC(?:x?\d+\.?\d*)?").unwrap());
pub static RE_AUDIO_PCM: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\b[LP]?PCM\b").unwrap());
pub static RE_AUDIO_OPUS: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bOPUS\b").unwrap());
pub static RE_AUDIO_MP3: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bMP3\b").unwrap());
...
pub static RE_CHAN_20: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\+?2[\.\s]0(?:x[2-4])?\b").unwrap());
pub static RE_CHAN_STEREO: LazyLock<Regex> =
...
/// 8-bit detection
pub static RE_BIT_DEPTH_8: LazyLock<Regex> =
...
pub static RE_GROUP_BRACKET: LazyLock<Regex> =
...
pub static RE_EXTENSION: LazyLock<Regex> = LazyLock::new(|| {
...
pub static RE_CONTAINER: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(r"(?i)\.?[\[(]?\b(MKV|AVI|MP4|WMV|MPG|MPEG|FLV|MOV|WEBM|TS|M4V|OGM|DIVX)\b[\])]?")
        .unwrap()
});
pub static RE_3D: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(r"(?i)\b(?:3D|SBS|half[- ]?(?:OU|SBS)|HSBS|BluRay3D|BD3D)\b").unwrap()
});
pub static RE_COMPLETE: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(
...
pub static RE_REGION_DISC: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(r"(?i)(?:^|[\W_])(?:DVD)?(R[0-9]J?|Region\s*[0-9])(?:$|[\W_])").unwrap()
});
pub static RE_SITE: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(
...
pub static RE_SITE_DOMAIN: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(r"(?i)\bwww?.?(?:\w+-)*\w+[.\s](?:com|org|net|ms|tv|mx|co|party|vip|nu|pics)\b")
        .unwrap()
});
pub static RE_SITE_KNOWN: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)rarbg|torrentleech|(?:the)?piratebay").unwrap());
pub static RE_SITE_BRACKET: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"\[([^\]]+\.[^\]]+)\](?:\.\w{2,4}$|\s|$)").unwrap());
pub static RE_VOLUME: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(
...
pub static RE_NON_ENGLISH_PREFIX: LazyLock<Regex> = LazyLock::new(|| {
...
pub static RE_EXTRAS: LazyLock<Regex> = LazyLock::new(|| {
...
pub static RE_EXTRAS_NCED: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"\bNCED\b").unwrap());
pub static RE_EXTRAS_NCOP: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"\bNCOP\b").unwrap());
pub static RE_EXTRAS_NC: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"\bNC\b").unwrap());
pub static RE_EXTRAS_OVA: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bOVA\b").unwrap());
pub static RE_EXTRAS_ED: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bED\d?v?\d?\b").unwrap());
pub static RE_EXTRAS_OP: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"\bOPv?\d*\b").unwrap());

pub static RE_TITLE_QUALITY: LazyLock<Regex> = LazyLock::new(|| {
...
pub static RE_REPACK: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\b(?:REPACK|RERIP)\b").unwrap());
pub static RE_RETAIL: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bRetail\b").unwrap());
pub static RE_UPSCALED: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(r"(?i)\b(?:AI[ .\-]?)?(?:Upscal(?:e[Dd]?|ing)|Enhanced?)\b").unwrap()
});
pub static RE_UPSCALED_SPECIFIC: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\b(?:iris2|regrade|ups(?:uhd|fhd|hd|4k))\b").unwrap());
pub static RE_UPSCALED_AI: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\b\.AI\.\b").unwrap());
pub static RE_REMASTERED: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bRemaster(?:ed)?\b").unwrap());
pub static RE_EXTENDED: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bEXTENDED\b").unwrap());
pub static RE_CONVERTED: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bCONVERT(?:ED)?\b").unwrap());
pub static RE_UNRATED: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bUNRATED\b").unwrap());
pub static RE_UNCENSORED: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bUNCENSORED\b").unwrap());
pub static RE_DUBBED: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(r"(?i)\b(?:DUBBED|DUAL(?:[ .\-]*(?:AU?|[AÁ]UDIO|LINE))?|DUBS?|DUBBING|DUBLADO|FAN\s*DUB|MULTI)\b").unwrap()
});
pub static RE_SUBBED: LazyLock<Regex> = LazyLock::new(|| {
    Regex::new(
        r"(?i)\b(?:SUBBED|SUBS?|SUBTITL(?:E[DS]?|ING)|multi(?:ple)?[ .\-]*(?:su$|sub\w*)|msub)\b",
    )
    .unwrap()
});
pub static RE_HARDCODED: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"\b(?:HC|HARDCODED)\b").unwrap());
pub static RE_DOCUMENTARY: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bDOCU(?:menta?ry)?\b").unwrap());
pub static RE_COMMENTARY: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bCOMMENTARY\b").unwrap());
pub static RE_ADULT: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"\b(?:XXX|xxx|Xxx)\b").unwrap());
pub static RE_PPV: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?i)\bPPV\b").unwrap());
pub static RE_PPV_FIGHT: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"(?i)\bFight[.\s_-]*Nights?\b").unwrap());
pub static RE_SCENE: LazyLock<Regex> = LazyLock::new(|| {
