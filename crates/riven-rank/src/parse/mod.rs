...
use patterns::{
    ...
    RE_RES_PREFIXED_2160, RE_RES_QHD, RE_RES_TYPO, RE_RES_WXH, RE_RETAIL, RE_SEASON_EP_COMPACT,
    RE_SEASON_FULL, RE_SEASON_MULTI, RE_SEASON_ORDINAL, RE_SEASON_PT, RE_SEASON_RANGE,
    RE_SEASON_RUSSIAN, RE_SEASON_RUSSIAN2, RE_SEASON_SE, RE_SEASON_TR, RE_SEASON_TV, RE_SITE,
    RE_SITE_BRACKET, RE_SITE_DOMAIN, RE_SITE_KNOWN, RE_SIZE, RE_SPRINT, RE_SUBBED, RE_UNCENSORED,
    RE_UNRATED, RE_UPSCALED, RE_UPSCALED_AI, RE_UPSCALED_SPECIFIC, RE_VOLUME, RE_YEAR,
    RE_YEAR_RANGE, RE_YEAR_RANGE_SHORT,
};
